...
//                       <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white/60 group-hover:text-white transition-colors duration-300" size={20} />
//                       <input 
//                         type="text" 
//                         placeholder="From"
...
//                       <select className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 backdrop-blur-sm appearance-none">
...
//                   {/* Search Button */}
//                   <button className={`w-full py-4 bg-gradient-to-r ${themeColors.gradient.gradient} hover:${themeColors.gradient.gradientHover} text-white rounded-xl font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 group`}>
