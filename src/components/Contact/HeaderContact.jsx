...
function HeaderContact() {
  return (
    <div className='hidden md:block bg-gray-50 border-b border-gray-200 py-2 px-4' style={{ backgroundColor: themeColors.neutral.lightBg(1) }}>
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-center'>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <div className='flex items-center gap-2' style={{ color: themeColors.neutral.text }}>
              <FiMail size={16} style={{ color: themeColors.primary.text }} />
              <span className="text-sm">info@flyelevatio.com</span>
            </div>
          </div>
